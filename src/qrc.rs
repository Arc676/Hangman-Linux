qrc!(qml_resources,
	"/" {
		...
		"qml/states/state0-dark.png",
		"qml/states/state1-dark.png",
		"qml/states/state2-dark.png",
		"qml/states/state3-dark.png",
		"qml/states/state4-dark.png",
		"qml/states/state5-dark.png",
		"qml/states/state6-dark.png",
		"qml/states/state7-dark.png",
		"qml/states/state8-dark.png",
		"qml/Main.qml",
		"qml/About.qml",
